        ...
        @foreach($words as $word)
            ...
            <div class="p-4 border rounded-md lg:col-span-1 md:col-span-2 xl:col-span-1">
                ...
                <div class="flex flex-col mt-6 border-b pb-4">
                    <button wire:click="removeWord({{ $word['id'] }})" class="bg-green-500 text-white py-1 px-2 mb-2 block"> بلد بودم</button>
                    <button wire:click="replaceWord({{ $word['id'] }})" class="bg-red-500 text-white py-1 px-2 block" >بلد نبودم</button>
                </div>
